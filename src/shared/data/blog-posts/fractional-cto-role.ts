...
export const fractionalCtoRole: BlogPost = {
    ...
    summary: "Most fractional CTO descriptions come from recruiters, not operators. Here is what they actually do each week, with advisory, embedded, and interim modes explained.",
    polymorphicSummary: {
...
> **AI Summary:** The fractional CTO model differs from a full-time hire in four structural ways: defined scope, exit orientation, cost structure, and political neutrality. LinkedIn Economic Graph (2024) reports fractional technology executive demand grew 57% year-over-year. Radford/Aon data (2024) shows fully loaded full-time CTO compensation at $280,000 to $400,000 at growth-stage companies. The fractional model delivers senior technical judgment at $8,000 to $25,000 per month, which is appropriate for companies that need the judgment before they can justify the full-time cost.
