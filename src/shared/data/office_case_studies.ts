...
export const officeCaseStudies: OfficeCaseStudy[] = [
    ...
    },
    {
        ...
        fullReport: {
            ...
            task: "The mission was to take command of a fractured 200+ FTE organization across 13 countries during the height of the COVID-19 pandemic. I had to enforce a single data standard to replace 'opinion-based management', eliminate the catastrophic regulatory exposure of side-channel trading, and rebuild the leadership layer from scratch.",
