...
export const ThemeMetadata = () => {
    ...
    useEffect(() => {
        ...
        switch (mode) {
            case "executive":
                message =
                    "Transitioning to the Executive Persona. This view represents the leadership aspect of Christopher Melson. The interface is designed to look and feel like a high-level executive report, with a clean, high-contrast boardroom aesthetic that offers a clear, vision-focused presentation of the core data.";
                break;
            case "strategist":
                message =
