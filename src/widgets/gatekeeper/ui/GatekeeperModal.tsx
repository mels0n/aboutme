        ...
        >
            ...
            <div className="relative z-10 w-full max-w-3xl flex flex-col items-center text-center">
                ...
                <motion.div
                    ...
                    className="max-w-4xl text-center space-y-8 md:space-y-12 p-6 md:p-12 rounded-2xl bg-surface/30 border border-white/10 shadow-2xl backdrop-blur-md w-full"
                >
                    {/* Headline */}
                    <div className="space-y-4 md:space-y-6">
                        <h1 className="text-xl md:text-3xl font-serif font-bold text-foreground leading-tight max-w-3xl mx-auto">
                            This Portfolio is Polymorphic.
                        </h1>
                        <p className="text-sm md:text-lg text-foreground/80 font-serif leading-relaxed max-w-3xl mx-auto">
                        ...
                        <p className="text-xs md:text-base text-foreground/60 font-sans tracking-wide pt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 text-left">
                        {/* The Boardroom */}
                        <div className="group p-4 md:p-5 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 transition-all hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div className="pt-2 md:pt-4">
                        <button
                            onClick={handleEnter}
                            className="text-sm font-mono font-bold uppercase tracking-[0.2em] text-foreground/60 hover:text-foreground transition-all hover:scale-105 px-4 py-2"
                        >
                            [ ENTER ]
                        </button>
                    </div>
